...
import { socket, SUGGESTED_QUESTIONS } from './ChatCardConfig';


import './ChatCard.css';
import renderTextWithFormatting from './renderTextWithFormatting';
import referenceLinks from './referenceLinks';
import LazyPlot from './LazyPlot';  // Import the LazyPlot component
...
function ChatCard({ openOverlay, openPrivacyOverlay }) {
  ...
  const [showTutorial, setShowTutorial] = useState(false); // State to handle the tutorial overlay
